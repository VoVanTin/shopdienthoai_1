<%@ Page Title="" Language="C#" MasterPageFile="~/indexLogined.master" AutoEventWireup="true" CodeFile="CartLogined.aspx.cs" Inherits="CartLogined" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align:center;padding-top:20px;padding-bottom:20px;">
        <asp:Label ID="Label1" Font-Bold="true" Font-Size="XX-Large" runat="server" Text="GIỎ HÀNG"></asp:Label></div>
    ...
    <div>
        <table style="width:90%;">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Button ID="btnThanhToan" runat="server" CssClass="nutchucnang" OnClick="btnThanhToan_Click" Text="Thanh Toán" />
                </td>
            </tr>
            </table>
        </div>
