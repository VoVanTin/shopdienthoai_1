<%@ Page Title="" Language="C#" MasterPageFile="~/indexLogined.master" AutoEventWireup="true" CodeFile="SanPhamLogined.aspx.cs" Inherits="SanPhamLogined" %>
        ...
        <table style="width: 100%;text-align:center;padding-top:10px;border:solid 1px gray">
            ...
            <tr>
                <td>
                    &nbsp;</td>
                <td colspan="2">
                    <asp:Label ID="lbTen" runat="server" Font-Bold="True" Font-Size="X-Large" Text='<%# Eval("TenHang") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
